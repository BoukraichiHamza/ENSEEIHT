...
let alphanum = alphabet | decimal | '_'
let commentaireBloc = (* A COMPLETER *) "/*" _* "*/" 
let commentaireLigne = (* A COMPLETER *) "//" _* '\n'

(* Analyseur syntaxique : expression reguliere { action CaML } *)
rule lexer = parse
...
(* Nombres entiers : A COMPLETER *)
  | ('0'|(decimal2) (decimal)*)? as texte   { (ENTIER (int_of_string texte)) }
(* Nombres flottants : A COMPLETER *)
  | (('0'|(decimal2)(decimal)*)? "." (decimal+)) as texte     { (FLOTTANT (float_of_string texte)) }
