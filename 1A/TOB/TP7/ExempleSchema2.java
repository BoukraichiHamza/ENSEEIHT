...
//On peut créer des segments à partir de point nommé car PointNomme est une sous classe de Point, le segment sera affiché de la même façon sauf au niveau du point où le nom sera aussi affiché ( afficher de PointNomme).
//Les modifications à faire, c'est déclarer des points en PointNomme et utiliser le constructeur de PointNomme. 
