...
public class Saisie extends JApplet {
	...
	class CButtonAction implements ActionListener {
		public void actionPerformed(ActionEvent ae) {
			...
			try {
				Carnet carnet =  (Carnet) Naming.lookup("//localhost/"+c);
				RFiche rfiche = carnet.Consulter(n,true);
				nom.setText(rfiche.getNom());
				email.setText(rfiche.getEmail());
				message.setText("L'Email de" + rfiche.getNom() +":" + rfiche.getEmail());
			} catch (Exception e){;
				e.printStackTrace();
			}
